...
;; get the four colors along with their current and their id
;; (element-at <list> <index>) returns the item of a list at a given index. It can also return none. Remember that indexes start at 0.
